 ...
 * Generated at: 2024-03-22 05:38:37 UTC
...
if(at != null){ 
      out.write("\r\n");
      out.write("						<!-- /jsp/resources/board_upfiles/changeName -->\r\n");
      out.write("						\r\n");
      out.write("						<a\r\n");
      out.write("						 download=\"");
      ...
      out.print( contextPath );
      out.write("/boardList?currentPage=1\"\r\n");
      out.write("		      		style=\"background-color: #ff52a0; height: 40px; color: white; border: 0px solid #388E3C; opacity: 0.8\">목록</a>&nbsp;&nbsp;\r\n");
      out.write("		      		\r\n");
      out.write("		      		");
if(loginUser != null && loginUser.getUserId().equals(board.getBoardWriter())){ 
      ...
      out.write("			          <a class=\"btn\" href=\"");
      out.print( contextPath );
      out.write("/updateForm.board?boardNo=");
      out.print( board.getBoardNo() );
      out.write("\"\r\n");
 ...
 if(loginUser != null) { 
      ...
      out.write("\r\n");
      out.write("							<td>\r\n");
      out.write("								<textarea readonly cols=\"50\" rows=\"3\" style=\"resize:none;\">로그인 후 이용가능한 서비스입니다.</textarea>\r\n");
      out.write("							</td>\r\n");
      ...
      out.write("			// Servlet요청 Ajax로 보내서 조회\r\n");
      out.write("			\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				url : 'replyList.do',\r\n");
      out.write("				data: {\r\n");
      out.write("					// 문자 보낼떄는 ''에 감쌓서 보낸다.\r\n");
      out.write("					boardNo : ");
      out.print( board.getBoardNo() );
      out.write(",\r\n");
      out.write("				},\r\n");
      ...
      out.write("								   + '</tr>'\r\n");
      out.write("					};\r\n");
      out.write("					$('#reply-area tbody').html(resultStr);\r\n");
      out.write("				},\r\n");
      out.write("				\r\n");
