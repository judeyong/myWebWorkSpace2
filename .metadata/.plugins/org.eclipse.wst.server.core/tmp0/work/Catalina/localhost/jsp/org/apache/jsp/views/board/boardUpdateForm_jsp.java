 ...
 * Generated at: 2024-03-18 01:38:30 UTC
...
public final class boardUpdateForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/board/../common/menubar.jsp", Long.valueOf(1710397854000L));
  }
...
if(loginUser == null) {
 ...
 if(loginUser == null) {
      out.write("\r\n");
      out.write("		<script>\r\n");
      out.write("			alert('글 작성은 회원만 가능합니다.');\r\n");
      out.write("			location.href = \"");
      out.print( contextPath );
      out.write("\";\r\n");
      out.write("		</script>\r\n");
      ...
      out.write("        <br><br> <!-- 파일 첨부 한 개 -->\r\n");
      out.write("        \r\n");
      out.write("        <form action=\"");
      out.print( contextPath );
      out.write("/update.board\" method=\"post\" id=\"insert-form\"\r\n");
      out.write("        	enctype=\"multipart/form-data\">\r\n");
      out.write("        <!-- 파일을 첨부하는 요청을 보낼 때는 반드시 form태그에다가 enctype=\"multipart/form-data\"를 추가를 해줘야함 -->	\r\n");
      out.write("        <!-- 제목, 내용, 카테고리, 작성자, 제출버튼  + 첨부파일 -->\r\n");
      out.write("        \r\n");
      out.write("        	\r\n");
 ...
 for(Category c : list){ 
      ...
      out.write("					\r\n");
      out.write("					/*\r\n");
      out.write("						board객체의 categoryName필드를 보면\r\n");
      out.write("						사용자가 게시글 작성 시 입력했던 categoryName이 들어있을 것\r\n");
      out.write("						\r\n");
      out.write("						board.getCategoryName()\r\n");
      out.write("					*/\r\n");
      out.write("		\r\n");
      out.write("					/*\r\n");
      ...
      out.write("                <input type=\"text\" class=\"form-control\" id=\"usr\" name=\"title\" value=\"");
      ...
      out.write("                <textarea class=\"form-control\" rows=\"15\" id=\"comment\" name=\"content\" style=\"resize: none;\">");
